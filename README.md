...
| ***Pariona Chacca, Angel Jose*** ***(TB1)*** | Elaboré y estructuré los segmentos de usuario y el análisis de entrevistas en el Capítulo 2, manteniendo un tono formal. | **TB1:** Adaptamos nuestra forma de comunicarnos según el perfil de la audiencia, estructurando informes y elaborando material audiovisual. Ajustamos nuestro lenguaje y expresión no verbal para transmitir claramente el contexto a nuestros evaluadores. |
...
| ***Pariona Chacca, Angel Jose*** ***(TP1)*** | Redacté las historias de usuario enfocadas en el backend y la lógica de validación de sensores. | **TP1:** Presentamos historias de usuario y arquitectura del sistema mediante documentos técnicos y sustentaciones orales, traduciendo necesidades del cliente a requerimientos técnicos comprensibles. |
...
| ***Pariona Chacca, Angel Jose*** ***(AV2)*** | Redacté las evidencias de desarrollo y colaboración del primer y segundo sprint en GitHub. | **AV2:** Documentamos y demostramos en vivo la primera versión funcional del sistema, empleando terminología técnica para la arquitectura y lenguaje ejecutivo para explicar el valor del producto. |
...
| ***Pariona Chacca, Angel Jose*** ***(TB2)*** | Elaboré la documentación de despliegue del Web Service en Render, y redacté la evidencia técnica del Sprint 4. | **TB2:** Sustentamos la aplicación integrada demostrando madurez técnica, documentando endpoints y redactando evidencias. Mantuvimos escucha activa para justificar las decisiones finales de desarrollo. |
...
| ***Pariona Chacca, Angel Jose*** ***(TB1)*** | Expuse el análisis del problema frente al equipo, utilizando lenguaje persuasivo para justificar el modelo de negocio. | |
...
| ***Pariona Chacca, Angel Jose*** ***(TP1)*** | Expliqué oralmente los criterios de aceptación de nuestras historias de usuario críticas ante el jurado. | |
...
| ***Pariona Chacca, Angel Jose*** ***(AV2)*** | Expliqué verbalmente el proceso de ramificación en Git y cómo manejamos los pull requests en equipo. | |
...
| ***Pariona Chacca, Angel Jose*** ***(TB2)*** | Argumenté la implementación de seguridad con JWT y el manejo transaccional de Spring Boot en la sustentación. | |
