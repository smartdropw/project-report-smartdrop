...
<img src="https://upload.wikimedia.org/wikipedia/commons/f/fc/UPC_logo_transparente.png" alt="Logo-UPC" width="160">
...
🔗 Enlace de la organización: https://github.com/smartdropw 
🔗 Enlace de repositorios: https://github.com/orgs/smartdropw/repositories
...
| ***Pariona Chacca, Angel Jose*** ***(TB1)*** | Elaboré y estructuré los segmentos de usuario y el análisis de entrevistas en el Capítulo 2, manteniendo un tono formal. | **TB1:** Adaptamos nuestra forma de comunicarnos por escrito según el perfil de la audiencia, estructurando los capítulos iniciales del informe para asegurar la correcta transmisión del contexto y el problema. |
| ***Barrenechea Bustamante, Rafael André*** ***(TB1)*** | Redacté la sección de antecedentes y las descripciones de la competencia directa e indirecta. | |
| ***Otiniano Rosales, Camila Alizée*** ***(TB1)*** | Diseñé el perfilamiento gráfico de los user personas y redacté los mapas de empatía de forma concisa. | |
| ***Uribe Linares, Francisco Javier*** ***(TB1)*** | Escribí la introducción del documento y recopilé los objetivos del proyecto asegurando buena redacción y coherencia. | |
| ***Pariona Chacca, Angel Jose*** ***(TP1)*** | Redacté las historias de usuario enfocadas en el backend y la lógica de validación de sensores. | **TP1:** Redactamos las historias de usuario y requerimientos funcionales traduciendo necesidades del cliente a lenguaje técnico comprensible para desarrolladores, manteniendo el contexto de negocio. |
| ***Barrenechea Bustamante, Rafael André*** ***(TP1)*** | Estructuré el product backlog y el impact mapping, priorizando las tareas técnicas por escrito. | |
| ***Otiniano Rosales, Camila Alizée*** ***(TP1)*** | Documenté los wireframes y el estilo de la interfaz web, explicando detalladamente los flujos de navegación. | |
| ***Uribe Linares, Francisco Javier*** ***(TP1)*** | Escribí los diagramas de arquitectura a nivel de contexto y contenedor, detallando las interacciones. | |
| ***Pariona Chacca, Angel Jose*** ***(AV2)*** | Redacté las evidencias de desarrollo y colaboración del primer y segundo sprint en GitHub. | **AV2:** Documentamos la primera versión del sistema funcional. Ajustamos nuestros manuales para que tanto desarrolladores frontend como evaluadores pudieran comprender la arquitectura desplegada. |
| ***Barrenechea Bustamante, Rafael André*** ***(AV2)*** | Documenté la integración inicial de los repositorios y la configuración de herramientas de desarrollo. | |
| ***Otiniano Rosales, Camila Alizée*** ***(AV2)*** | Escribí el informe de evidencias sobre el despliegue del frontend en Netlify y su testing visual. | |
| ***Uribe Linares, Francisco Javier*** ***(AV2)*** | Detallé el diseño de base de datos y los diagramas de clases, utilizando un lenguaje técnico estándar (UML). | |
| ***Pariona Chacca, Angel Jose*** ***(TB2)*** | Elaboré la documentación de despliegue del Web Service en Render, y redacté la evidencia técnica del Sprint 4. | **TB2:** Consolidamos el informe final redactando evidencias técnicas avanzadas sobre el Web Service y endpoints, asegurando que la complejidad del sistema sea fácilmente legible. |
| ***Barrenechea Bustamante, Rafael André*** ***(TB2)*** | Documenté los Endpoints a través de Swagger UI, redactando las descripciones de uso de la API. | |
| ***Otiniano Rosales, Camila Alizée*** ***(TB2)*** | Redacté las conclusiones de usabilidad y experiencia de usuario del flujo integrado Frontend-Backend. | |
| ***Uribe Linares, Francisco Javier*** ***(TB2)*** | Consolidé la revisión ortográfica final de todo el informe y documenté la configuración de CORS. | |
| **Comunica oralmente con efectividad a diferentes rangos de audiencia** | | |
| ***Pariona Chacca, Angel Jose*** ***(TB1)*** | Expuse el análisis del problema frente al equipo, utilizando lenguaje persuasivo para justificar el modelo de negocio. | **TB1:** Sustentamos el problema y la necesidad del proyecto de forma clara y empática. Ajustamos nuestra comunicación no verbal para asegurar la atención y comprensión del jurado evaluador. |
| ***Barrenechea Bustamante, Rafael André*** ***(TB1)*** | Presenté oralmente el análisis de competidores a los stakeholders, sintetizando los puntos críticos de mercado. | |
| ***Otiniano Rosales, Camila Alizée*** ***(TB1)*** | Lideré la sustentación del journey map simulando los escenarios del usuario objetivo durante la presentación. | |
| ***Uribe Linares, Francisco Javier*** ***(TB1)*** | Abrí la exposición con el resumen del proyecto, logrando conectar rápidamente con la audiencia desde el inicio. | |
| ***Pariona Chacca, Angel Jose*** ***(TP1)*** | Expliqué oralmente los criterios de aceptación de nuestras historias de usuario críticas ante el jurado. | **TP1:** Orientamos nuestro discurso hacia la presentación de requerimientos y el diseño de la arquitectura, demostrando capacidad técnica para debatir sobre diagramas UML con los evaluadores. |
| ***Barrenechea Bustamante, Rafael André*** ***(TP1)*** | Argumenté las decisiones de arquitectura de software, defendiendo verbalmente el uso de capas y dominios. | |
| ***Otiniano Rosales, Camila Alizée*** ***(TP1)*** | Expuse el diseño UX/UI y el flujo de pantallas interactivo (mockups), respondiendo dudas de usabilidad. | |
| ***Uribe Linares, Francisco Javier*** ***(TP1)*** | Presenté el modelo relacional de la base de datos de manera didáctica para una audiencia no especializada. | |
| ***Pariona Chacca, Angel Jose*** ***(AV2)*** | Expliqué verbalmente el proceso de ramificación en Git y cómo manejamos los pull requests en equipo. | **AV2:** Realizamos demostraciones en vivo (demos) donde explicamos oralmente las funcionalidades de nuestra primera versión desplegada, usando terminología técnica y ejecutiva según la pregunta. |
| ***Barrenechea Bustamante, Rafael André*** ***(AV2)*** | Presenté la primera demostración técnica en vivo de la aplicación ejecutándose de forma local. | |
| ***Otiniano Rosales, Camila Alizée*** ***(AV2)*** | Lideré la sustentación oral del frontend desplegado en la nube, mostrando las respuestas responsivas de la app. | |
| ***Uribe Linares, Francisco Javier*** ***(AV2)*** | Dialogué con el jurado sobre el manejo de estados de la aplicación y la estructura principal del código base. | |
| ***Pariona Chacca, Angel Jose*** ***(TB2)*** | Argumenté la implementación de seguridad con JWT y el manejo transaccional de Spring Boot en la sustentación. | **TB2:** Sustentamos la aplicación integrada demostrando madurez técnica. Mantuvimos escucha activa y concisión para justificar nuestras excepciones de backend y configuraciones de seguridad. |
| ***Barrenechea Bustamante, Rafael André*** ***(TB2)*** | Presenté verbalmente en la sustentación final la disponibilidad y uso del Web Service a través de Swagger. | |
| ***Otiniano Rosales, Camila Alizée*** ***(TB2)*** | Defendí oralmente las mejoras aplicadas en el diseño final y el flujo de navegación del usuario conectado al API. | |
| ***Uribe Linares, Francisco Javier*** ***(TB2)*** | Cerré la presentación exponiendo las métricas de colaboración y los aprendizajes finales adquiridos por el equipo. |
---
...
![User Persona](/assets/chapter2/Rosa%20Gutiérrez%20(1).png)
...
![User Persona](/assets/chapter2/Mariana%20Torres%20(1).png)
...
![Empathy Map](/assets/chapter2/Empathy%20map%20(1).png)
...
![Empathy Map](/assets/chapter2/Empathy%20map%202%20(1).png)
...
![Event Storming](/assets/chapter2/Event%20storming%20Hogares%20(1).jpeg)

### Segmento PYMEs de Bebidas

![Event Storming](/assets/chapter2/Empathy%20map%202%20(1).png)
...
- Enfocado en beneficios tangibles para hogares y empresas en el monitoreo inteligente de líquidos
...
**Colores de Marca:**
- **Primario:** Azul turquesa/teal (#46b5b8) – Color principal para header y navegación
- **Secundario:** Azul claro para CTAs principales (#5DADE2) – Para botones como "Get Started" y "Choose Plan"
- **Accento púrpura/morado:** (#7C3AED) – Para el botón "Send" del formulario únicamente
...
- **Fondo:** Gradientes suaves azul-violeta y fondos claros – Para secciones de transición
- **Fondo principal:** Blanco y tonos muy claros – Para contenido general

**Paleta de Colores:**

| Color             | Código Hex        | Uso Principal |
|-------------------|-------------------|---------------|
| Teal Principal    | #46b5b8           | Header, navegación, elementos brand |
| Azul CTA          | #5DADE2           | Botones principales: "Get Started", "Choose Plan" en Pro |
| Púrpura/Morado    | #7C3AED           | Botón "Send" del formulario únicamente |
| Azul Recomendado  | #5DADE2           | Badge "Recommended" en plan Pro |
...
- Fondo azul turquesa/teal (#46b5b8) distintivo

**Hero Section:**
- Título principal impactante: "Monitoreo inteligente de líquidos para hogares y empresas"
- Descripción clara del valor: "Rastrea volumen, presión, densidad y temperatura de diversos líquidos en tiempo real con alertas claras e informes detallados"
- Botones duales: "Get Started" (azul claro #5DADE2) y "Learn More" (outline secundario)
- Badge destacado "Real-Time Liquid Monitoring" en verde claro
- Métricas de confianza horizontales: "Sensores certificados • 99.9% tiempo activo • Panel de control en la nube"
- Dashboard visual mostrando métricas de líquidos en tiempo real para múltiples tipos de líquidos

**Secciones de Contenido:**

**Full visibility of your liquids:**
- Título principal de la sección con descripción: "Monitor liquid tanks and pipelines, measuring volume, pressure and temperature with clear dashboards and configurable alerts"
- Tres funcionalidades principales en cards horizontales con iconos distintivos:
    - **Volume Management (ícono gota azul):** "Record levels, calculate consumption and predict replenishments"
    - **Pressure Tracking (ícono presión circular):** "Detect pressure variations to prevent line damage"
    - **Temperature Control (ícono termómetro rojo):** "Ensure ideal ranges with smart alerts"

**Sección "Supported liquids":** Nueva sección específica con seis cards organizadas en grid 3x2:
- **Gasoline:** "Level, temperature and safety thresholds for fuels"
- **Beer:** "Fermentation, temperature and volume control"
- **Honey:** "Viscosity-aware volume and temperature ranges"
- **Molasses:** "High-density tracking and pump-friendly alerts"
- **Chemicals:** "Compliance, storage conditions and spill alerts"
...
- Todos con rol "Ingeniería de Software"
- Iconos de redes sociales (Facebook, Twitter, Instagram) en cada perfil
- Diseño de cards limpias con bordes redondeados

**Solutions by segment:** Dos cards principales:
- **Residences:** "Monitorea tanques de líquidos domésticos, recibe alertas de nivel bajo y previene fugas"
- **Businesses:** "Controla inventarios de líquidos, auditorías de uso y cumplimiento para gestión de líquidos"

**Key features:** Tres cards con descripciones técnicas organizadas horizontalmente:
...
**Subscription plans:** Tres columnas con precios y características destacando el plan recomendado:
- **Basic $19/mo:** 1 tank, Update every 15 min, Basic alerts, Email support - Botón "Choose Plan" outline azul
- **Pro $49/mo (Badge "Recommended" azul destacado):** Up to 5 tanks, Update every 5 min, Advanced alerts, Shared dashboards, Priority support - Botón "Choose Plan" sólido azul
...
- "What liquids can I monitor?"
- "Do I need constant internet?"
- "How do alerts work?"

**Contact Sales:**
- Descripción: "Tell us about your operation and a specialist will contact you"
- Formulario con campos: Name, Email, Message (área de texto más grande)
- Botón "Send" en púrpura/morado (único botón de este color en el sitio)
...
La landing page se diseñó con un flujo lógico que guía al usuario desde el primer impacto visual hasta la acción final. La organización está pensada para usuarios tanto familiarizados como no familiarizados con la tecnología IoT de monitoreo de líquidos, priorizando simplicidad, claridad y conversión.

**Orden lógico de las secciones:**
1. **Hero:** Primer impacto visual con título, subtítulo y botones CTA duales
2. **Full visibility:** Descripción de las capacidades principales de monitoreo de líquidos diversos
...
5. **Solutions by segment:** Diferenciación clara entre Residences y Businesses para monitoreo de líquidos
6. **Key features:** Funcionalidades técnicas detalladas para líquidos
7. **Subscription plans:** Estructura de precios clara con tres opciones
8. **What our customers say:** Testimonios de clientes reales con casos de éxito en monitoreo de líquidos
9. **FAQ:** Resolución de dudas comunes sobre monitoreo de líquidos
...
- **Jerárquico:** Se organiza de lo más importante (valor del producto de monitoreo de líquidos y CTA inicial) hacia lo más detallado (planes, FAQ, contacto)
- **Secuencial:** Sigue un recorrido natural: Qué es → Quién somos → Soluciones → Características → Precios → Contacto
- **Por audiencia:** Diferenciación clara entre segmentos residencial y empresarial para gestión de líquidos diversos
- **Por funcionalidad:** Agrupación lógica de características técnicas de monitoreo de líquidos por tipo y aplicación industrial
...
- "Monitoreo inteligente de líquidos para hogares y empresas"
- "Full visibility of your liquids"
...
**Keywords:** Monitoreo inteligente de líquidos, gestión de líquidos, sensores IoT, monitoreo de tanques, seguimiento de presión de líquidos, control de temperatura de líquidos, gestión de volumen de líquidos, alertas en tiempo real, gasolina, cerveza, miel, melaza, químicos
...
- Diferenciación por tipos de líquidos monitoreables

**Búsqueda por contenido:**
- FAQ section para resolución rápida de dudas sobre monitoreo de líquidos diversos
- Navegación anclada para acceso directo a secciones específicas
- Breadcrumbs visuales a través del scroll
- Sección de tipos de líquidos para acceso rápido a casos de uso específicos
...
- Hero section: "Get Started" (azul claro #5DADE2) y "Learn More" (outline secundario)
- Planes de suscripción: "Choose Plan" (outline azul) en Basic y Enterprise, "Choose Plan" (azul sólido #5DADE2) en Pro
- Formulario de contacto: "Send" (púrpura/morado #7C3AED - único botón de este color del sitio)
- Distribución estratégica de CTAs en azul claro excepto el envío de formulario en morado
...
- Métricas destacadas: "99.9% uptime", "Sensores certificados para líquidos"
- Presentación completa del equipo técnico
- Testimonios reales de clientes con casos de éxito específicos en gestión de líquidos
- Métricas de confiabilidad y resultados cuantificables por tipo de líquido


## 4.3. Landing Page UI Design


En esta sección se presenta la propuesta de diseño de interfaz de usuario para la Landing
Page del producto. Se inicia con una introducción donde se explica cómo las decisiones de
diseño visual y arquitectura de la información se traducen en una experiencia clara,
atractiva y funcional para el usuario. La propuesta busca reflejar la identidad del
producto, captar la atención de los visitantes y facilitar la comprensión de su valor
...
los diferentes tipos de líquidos monitoreables (gasolina, cerveza, miel, melaza,
químicos y otros), las funcionalidades clave del sistema de monitoreo inteligente,
nuestro equipo, planes de suscripciones adaptados a diferentes volúmenes de tanques,
testimonios de usuarios con casos de éxito específicos en gestión de líquidos, y secciones
informativas sobre soluciones por segmento (residencial y empresarial). Al final, se encuentra
